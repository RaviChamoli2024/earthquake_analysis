...
if __name__ == "__main__":
    # Verify directory structure and run the workflow
    print("\nVerifying directory structure")
    if not earthquake_analysis_path.exists():
        print("Directory 'earthquake_analysis' is missing.")
        sys.exit(1)

    data_path = PROJECT_ROOT / 'data'
    if not data_path.exists():
        print("Directory 'data' is missing.")
        sys.exit(1)

    print("\nStarting earthquake data analysis workflow")
    workflow_earthquake_analysis()
